              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Enterate de las opiniones de los juegos del momento!!',
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              StreamBuilder<List<UsernameRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<UsernameRecord>
                                      buttonUsernameRecordList = snapshot.data!;
                                  // Return an empty Container when the item does not exist.
                                  if (snapshot.data!.isEmpty) {
                                    return Container();
                                  }
                                  final buttonUsernameRecord =
                                      buttonUsernameRecordList.isNotEmpty
                                          ? buttonUsernameRecordList.first
                                          : null;

                                  return FFButtonWidget(
                                    onPressed: () async {
                                      Function() _navigate = () {};
                                      if (buttonUsernameRecord?.usernameInUse
                                              ?.contains(_model
                                        ...
                                        await buttonUsernameRecord!.reference
                                            .update({
                                          ...mapToFirestore(
                                            {
                                              'username_in_use':
