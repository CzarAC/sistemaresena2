...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? PerfilWidget() : IniciodeSesionWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: PagmenuWidget.routeName,
          path: PagmenuWidget.routePath,
          builder: (context, params) => PagmenuWidget(),
        ),
        FFRoute(
          name: DetallesVideojuegoWidget.routeName,
          path: DetallesVideojuegoWidget.routePath,
          builder: (context, params) => DetallesVideojuegoWidget(
            referencia: params.getParam(
              'referencia',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['videojuegos'],
            ),
          ),
        ),
        FFRoute(
