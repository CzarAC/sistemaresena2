...
class Modal03CreateMessageBottomWidget extends StatefulWidget {
  ...
  final DocumentReference? videojuegos;

  @override
  State<Modal03CreateMessageBottomWidget> createState() =>
...
class _Modal03CreateMessageBottomWidgetState
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<VideojuegosRecord>(
      stream: VideojuegosRecord.getDocument(widget!.videojuegos!),
      builder: (context, snapshot) {
        ...
        final createNoteVideojuegosRecord = snapshot.data!;
          ...
          child: Container(
            ...
            child: Stack(
              children: [
                ...
                Align(
                  alignment: AlignmentDirectional(-0.06, 1.2),
                  child: Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(0.0, 24.0, 0.0, 44.0),
                    child: FFButtonWidget(
                      onPressed: () async {
                        await ResenasRecord.createDoc(widget!.videojuegos!)
                            .set(createResenasRecordData(
                          email: currentUserEmail,
                          resena: _model.shortBioTextController.text,
                        ...
                        await createNoteVideojuegosRecord.reference.update({
                          ...mapToFirestore(
                            {
